    ...
    <div className="min-h-screen py-20 text-white">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto">
          <p className="text-cyan-400 font-medium uppercase tracking-[4px]">
            My Services
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mt-16">
          {services.map((service, index) => (
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-cyan-500/10 text-cyan-400 flex items-center justify-center mb-6 group-hover:bg-cyan-500 group-hover:text-white transition-all duration-300">
                {service.icon}
              </div>
        ...
        <div className="mt-28">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-gray-400 mt-5 text-base md:text-lg">
              A brief overview of my work experience, internships, and academic
              background in web development and computer science.
            </p>
          </div>
